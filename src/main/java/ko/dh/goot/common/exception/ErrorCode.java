...
public enum ErrorCode {
    ...
    RESOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, "C004", "RESOURCE를 찾을수 없습니다."),
    ...
    USER_ROLE_INVALID(HttpStatus.UNAUTHORIZED, "A005", "잘못된 권한입니다."),
    ...
    PRODUCT_OPTION_NOT_FOUND(HttpStatus.NOT_FOUND, "P002", "상품 옵션이 존재하지 않습니다."),
    OUT_OF_STOCK(HttpStatus.BAD_REQUEST, "P003", "상품 재고가 부족합니다."),
    PRODUCT_STOCK_UPDATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "P004", "상품 재고 수량 변경에 실패했습니다."),
